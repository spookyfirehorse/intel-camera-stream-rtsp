ffmpeg -hwaccel vdpau   -fflags nobuffer -flags low_delay -hide_banner  -strict experimental  \
   -f pulse   -i alsa_input.pci-0000_00_0e.0.analog-stereo  -f v4l2   -i /dev/video0 -c:v libx264 -b:v 1M  -preset ultrafast -tune zerolatency -maxrate 1M -minrate 1M -bufsize 500k  -bf 0   \
